...
class SizeConfig {
  ...
  static double getSW(BuildContext context) {
    _mediaQueryData = MediaQuery.of(context);
    return _mediaQueryData.size.width;
  }

  static double getSH(BuildContext context) {
    _mediaQueryData = MediaQuery.of(context);
...
double getProportionateScreenHeight(BuildContext context, double inputHeight) {
  double screenHeight = SizeConfig.getSH(context);
...
double getProportionateScreenWidth(BuildContext context, double inputWidth) {
  double screenWidth = SizeConfig.getSW(context);
